...
\begin{align*}
    ...
    &\hspace{1em}-D_\KL\left(q\left(\dynmat,\dyncovar\right)\|p\left(\dynmat,\dyncovar\right)\right)\\
    &\hspace{1em}-\mathbb{E}_q\left[D_\KL\left(q\left(\state_{1:\horizon}~\big|~\dynmat,\dyncovar;\observation_{1:\horizon},\action_{1:\horizon}\right)\|\right.\right.\\
...
\STATE{$\model\leftarrow\textsc{TrainModel}(\dataset,\xi_\model)$ (\autoref{sec:modeling})}
